...
const VaultView = (() => {
  ...
  const MODEL_CATALOG = [
    ...
    { id: 'gemini-2-5-flash', name: 'Gemini 2.5 Flash', provider: 'Google',    speed: 'fastest', quality: 'good',      desc: 'High-volume scaling. Best-in-class economics. Always free.', icon: 'circle', vision: true, pdf: true },

    // ── Standard pool (Pro)
    { id: 'gpt-5-mini',       name: 'GPT-5 mini',       provider: 'OpenAI',    speed: 'fast',    quality: 'good',      desc: 'Low-cost, reliable general intelligence. Default workhorse.', icon: 'circle', vision: true, pdf: false },
    ...
    { id: 'llama-4-scout',    name: 'Llama 4 Scout',    provider: 'Meta',      speed: 'medium',  quality: 'good',      desc: '10M context window for local and air-gapped environments.',  icon: 'circle', vision: false, pdf: false },
    ...
    { id: 'grok-4-1-fast',    name: 'Grok 4.1 Fast',    provider: 'xAI',       speed: 'fast',    quality: 'excellent', desc: 'Industry-leading 2M token context window. Real-time research.', icon: 'circle', vision: false, pdf: false },

    // ── Claude pool (Claude add-on)
    { id: 'claude-4-6-sonnet', name: 'Claude 4.6 Sonnet', provider: 'Anthropic', speed: 'fast',  quality: 'excellent', desc: 'Best balance of speed, cost, and intelligence. Production default.', icon: 'circle', vision: true, pdf: true },
    { id: 'claude-4-7-opus',   name: 'Claude 4.7 Opus',   provider: 'Anthropic', speed: 'slow',  quality: 'best',      desc: 'Expert writing and nuanced synthesis. Premium flagship.',           icon: 'circle', vision: true, pdf: true },

    // ── Premium pool (Premium add-on)
    { id: 'gpt-5-4-pro',      name: 'GPT-5.4 Pro',     provider: 'OpenAI',    speed: 'medium',  quality: 'best',      desc: '1M context, 128K output, multimodal. OpenAI\'s flagship.',     icon: 'circle', vision: true, pdf: false },
    // Codex is tuned for agentic coding; OpenAI lists vision but we don't send
    // images to it until a product case emerges.
    { id: 'gpt-5-3-codex',    name: 'GPT-5.3 Codex',   provider: 'OpenAI',    speed: 'fast',    quality: 'excellent', desc: 'Specialized for agentic coding tasks. Code flagship.',          icon: 'circle', vision: false, pdf: false },
    { id: 'openai-o3',        name: 'OpenAI o3',       provider: 'OpenAI',    speed: 'slow',    quality: 'best',      desc: 'Frontier-level reasoning and STEM solving. Hardest problems.',  icon: 'circle', vision: true, pdf: false },
    { id: 'gemini-2-5-pro',   name: 'Gemini 2.5 Pro',  provider: 'Google',    speed: 'medium',  quality: 'excellent', desc: 'Native multimodal synthesis. 1M+ token context window.',         icon: 'circle', vision: true, pdf: true },
  ];
