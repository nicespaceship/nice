...
const IntegrationsView = (() => {
  ...
  const MCP_CATALOG = [
    ...
    { id:'replicate', name:'Replicate',         desc:'Bring your own Replicate account — search and run thousands of open-source models (Flux, Stable Diffusion, Kling, Luma, Bark) billed to your Replicate account, not NICE', icon:'brand-replicate', tools:['search_models','list_models','get_model','create_prediction','get_prediction','cancel_prediction','list_collections','get_collection','list_hardware','get_account'], transport:'streamable-http', auth:'oauth', cat:'media' },
