...
const Stacks = (() => {
  ...
  const STACKS = {
    ...
    builder: {
      ...
      icon: '🔨',
      description: 'Solo developers shipping code. GPT-5.4 Pro for agentic coding tasks, fast iteration on cheap budget models, free chitchat.',
      models: ['gpt-5-4-pro', 'gpt-5-mini', 'gemini-2-5-flash'],
    ...
    writer: {
      ...
      models: ['claude-4-7-opus', 'claude-4-6-sonnet', 'gpt-5-mini', 'gemini-2-5-flash'],
      requires: { pro: true, addons: ['claude'] },
      niceAutoRouting: {
        polish: 'claude-4-7-opus',
    ...
    analyst: {
      ...
      models: ['openai-o3', 'claude-4-7-opus', 'gemini-2-5-flash'],
      requires: { pro: true, addons: ['claude', 'premium'] },
      niceAutoRouting: {
        reasoning: 'openai-o3',
        synthesis: 'claude-4-7-opus',
