...
const Stacks = (() => {
  ...
  const STACKS = {
    ...
    pro: {
      ...
      icon: '💰',
      description: 'Five standard models covering reasoning, long context, and budget compute. Perfect for users who don\'t need flagship Claude or GPT.',
      models: ['gpt-5-mini', 'deepseek-r1', 'glm-5', 'llama-4-scout', 'gemini-2-5-flash'],
    ...
    operator: {
      ...
      models: ['kimi-k2-5', 'claude-4-6-sonnet', 'gemini-2-5-flash'],
      requires: { pro: true, addons: ['claude'] },
      niceAutoRouting: {
        agent:     'kimi-k2-5',
