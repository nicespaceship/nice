...
const Stacks = (() => {
  ...
  const STACKS = {
    ...
    pro: {
      ...
      icon: '💰',
      description: 'Six standard models covering reasoning, multilingual, RAG, and budget compute. Perfect for users who don\'t need flagship Claude or GPT.',
      models: ['gpt-5-mini', 'deepseek-r1', 'mistral-large-3', 'glm-5', 'llama-4-scout', 'gemini-2-5-flash'],
    ...
    builder: {
      ...
      models: ['gpt-5-3-codex', 'gpt-5-mini', 'deepseek-r1', 'gemini-2-5-flash'],
    ...
    researcher: {
      ...
      icon: '🔭',
      description: 'Long documents, citation-heavy work, multi-source synthesis. 2M-token Grok for raw reach, Gemini 3.1 Pro for multimodal, DeepSeek for cheap parallel reasoning.',
      models: ['grok-4-1-fast', 'gemini-3-1-pro', 'deepseek-r1', 'gemini-2-5-flash'],
      requires: { pro: true, addons: ['premium'] },
      niceAutoRouting: {
    ...
    operator: {
      ...
      icon: '🤖',
      description: 'Agentic workflows, tool calls, RAG retrieval. Models that follow plans and call tools reliably without going off-script.',
      models: ['kimi-k2-5', 'claude-4-6-sonnet', 'command-r-plus', 'gemini-2-5-flash'],
      requires: { pro: true, addons: ['claude'] },
      niceAutoRouting: {
        agent:     'kimi-k2-5',
        toolcall:  'claude-4-6-sonnet',
        retrieval: 'command-r-plus',
        cheap:     'gemini-2-5-flash',
      },
    },
    analyst: {
      ...
      icon: '📊',
      description: 'Frontier reasoning for the hardest problems. OpenAI o3 for primary reasoning, Claude Opus as a cross-check path, DeepSeek for cheap parallel runs.',
      models: ['openai-o3', 'claude-4-6-opus', 'deepseek-r1', 'gemini-2-5-flash'],
      requires: { pro: true, addons: ['claude', 'premium'] },
      niceAutoRouting: {
        reasoning: 'openai-o3',
        synthesis: 'claude-4-6-opus',
        parallel:  'deepseek-r1',
        cheap:     'gemini-2-5-flash',
      },
    },
  };
