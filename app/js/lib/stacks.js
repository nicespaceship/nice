...
const Stacks = (() => {
  ...
  const STACKS = {
    ...
    pro: {
      ...
      icon: '💰',
      description: 'Four standard models covering reasoning, long context, and budget compute. Perfect for users who don\'t need flagship Claude or GPT.',
      models: ['gpt-5-mini', 'glm-5', 'llama-4-scout', 'gemini-2-5-flash'],
