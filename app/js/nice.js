...
const Theme = (() => {
  ...
  const THEMES = [
    { id:'nice', name:'CORE', persona:{ name:'CORE', callsign:'Commander' }, chatsLabel:'Chats', builtin:true, accent:'#080808', preview:['#080808','#ffffff','#888888'],
    ...
    { id:'hal-9000', name:'HAL-9000', persona:{ name:'HAL', callsign:'Dave' }, chatsLabel:'Mission Logs', builtin:true, accent:'#ef4444', preview:['#000000','#ef4444','#8a8a90'],
    ...
    { id:'grid', name:'The Grid', persona:{ name:'End of Line', callsign:'User' }, chatsLabel:'Logs', builtin:true, accent:'#18a0fb', preview:['#02090f','#18a0fb','#0a6bc4'],
    ...
    { id:'matrix', name:'The Matrix', persona:{ name:'Morpheus', callsign:'Neo' }, chatsLabel:'Transmissions', builtin:true, accent:'#00ff41', preview:['#000800','#00ff41','#00aa2a'],
      ...
      voice:{ provider:'elevenlabs', voice:'morpheus', speed:1.0, model:'eleven_turbo_v2_5', label:'Morpheus',
        ...
        intro:'Welcome, Neo.' } },
    { id:'lcars', name:'LCARS', persona:{ name:'Computer', callsign:'Captain' }, chatsLabel:'Records', builtin:true, accent:'#ff9966', preview:['#000000','#ff9966','#cc99ff'],
    ...
    { id:'jarvis', name:'J.A.R.V.I.S.', persona:{ name:'JARVIS', callsign:'Sir' }, chatsLabel:'Sessions', builtin:true, accent:'#00e5ff', preview:['#070d1a','#00e5ff','#18ffff'],
    ...
    { id:'cyberpunk', name:'Cyberpunk', persona:{ name:'Delamain', callsign:'V' }, chatsLabel:'Calls', builtin:true, accent:'#ff2d6f', preview:['#0a0a0f','#ff2d6f','#00fff5'],
    ...
    { id:'rx-78-2', name:'RX-78-2', persona:{ name:'Operator', callsign:'Pilot' }, chatsLabel:'Comms', builtin:true, accent:'#2b4e8c', preview:['#12131a','#2b4e8c','#c0392b'],
    ...
    { id:'16bit', name:'16-BIT', persona:{ name:'Announcer', callsign:'Player One' }, chatsLabel:'Saves', builtin:true, accent:'#e2b714', preview:['#1a1a2e','#e2b714','#2980b9'],
    ...
    { id:'office', name:'The Office', persona:{ name:'Dwight', callsign:'Captain' }, chatsLabel:'Memos', builtin:true, accent:'#0F52BA', preview:['#f0f0f2','#0F52BA','#3b7dd8'],
    ...
    { id:'office-dark', name:'The Office', persona:{ name:'Dwight', callsign:'Captain' }, chatsLabel:'Memos', builtin:false, accent:'#a5b4fc', preview:['#09090b','#a5b4fc','#e0e7ff'],
