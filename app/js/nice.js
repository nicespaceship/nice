...
const Theme = (() => {
  ...
  const THEMES = [
    ...
    { id:'jarvis', name:'J.A.R.V.I.S.', builtin:true, accent:'#4fc3f7', preview:['#070d1a','#4fc3f7','#80d8ff'],
      data:{ colors:{ '--bg':'#070d1a','--bg2':'#0c1829','--surface':'rgba(79,195,247,0.04)','--surface2':'rgba(79,195,247,0.08)','--border':'rgba(79,195,247,0.18)','--border-hi':'rgba(79,195,247,0.5)','--accent':'#4fc3f7','--accent2':'#80d8ff','--text':'#b8d8f0','--text-muted':'rgba(79,195,247,0.55)','--glow':'0 0 16px rgba(79,195,247,0.2)','--panel-bg':'rgba(7,13,26,0.95)' }, fonts:{ '--font-h':"'Exo 2', sans-serif", '--font-b':"'Inter', sans-serif" }, radius:'3px' } },
    ...
    { id:'office', name:'The Office', builtin:true, accent:'#a5b4fc', preview:['#fafafa','#4f46e5','#a5b4fc'],
      data:{ colors:{ '--bg':'#c8c8cd','--bg2':'#b8b8bf','--bg-alt':'#d0d0d5','--surface':'rgba(0,0,0,0.02)','--surface2':'#f0f0f2','--border':'#e4e4e7','--border-hi':'#a1a1aa','--accent':'#4f46e5','--accent2':'#6366f1','--text':'#09090b','--text-muted':'#71717a','--text-dim':'#a1a1aa','--glow':'0 0 0 1px rgba(99,102,241,0.06)','--glow-hi':'0 0 12px rgba(99,102,241,0.08)','--panel-bg':'#ffffff','--panel-border':'#e4e4e7' }, fonts:{ '--font-h':"'Inter', sans-serif", '--font-b':"'Inter', sans-serif" }, radius:'10px' } },
    { id:'office-dark', name:'The Office', builtin:false, accent:'#a5b4fc', preview:['#09090b','#a5b4fc','#e0e7ff'],
      data:{ colors:{ '--bg':'#09090b','--bg2':'#18181b','--bg-alt':'#18181b','--surface':'rgba(255,255,255,0.03)','--surface2':'#27272a','--border':'#3f3f46','--border-hi':'#71717a','--accent':'#e0e7ff','--accent2':'#a5b4fc','--text':'#fafafa','--text-muted':'#a1a1aa','--text-dim':'#3f3f46','--glow':'0 0 0 1px rgba(224,231,255,0.06)','--glow-hi':'0 0 12px rgba(224,231,255,0.08)','--panel-bg':'rgba(24,24,27,0.75)','--panel-border':'#3f3f46' }, fonts:{ '--font-h':"'Inter', sans-serif", '--font-b':"'Inter', sans-serif" }, radius:'10px' } },
  ];
