...
const Theme = (() => {
  ...
  const THEMES = [
    ...
    { id:'robotech', name:'Pod', builtin:true, accent:'#0ea5e9', preview:['#fafafa','#0ea5e9','#8b5cf6'],
      data:{ colors:{ '--bg':'#fafafa','--bg2':'#f0f0f5','--surface':'rgba(14,165,233,0.04)','--surface2':'rgba(139,92,246,0.04)','--border':'rgba(14,165,233,0.15)','--border-hi':'#0ea5e9','--accent':'#0ea5e9','--accent2':'#8b5cf6','--text':'#1a1a2e','--text-muted':'#6b7280','--glow':'0 0 20px rgba(14,165,233,0.1)','--panel-bg':'rgba(255,255,255,0.85)' }, fonts:{ '--font-h':"'Inter', sans-serif", '--font-b':"'Inter', sans-serif" }, radius:'12px' } },
