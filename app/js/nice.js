...
const Theme = (() => {
  ...
  const THEMES = [
    { id:'spaceship', name:'NICE', builtin:true, accent:'#080808', preview:['#080808','#ffffff','#888888'],
      ...
      // calm and articulate. Resolves to ELEVENLABS_KITT_VOICE_ID server-side
      // (kept as the resolver key so the secret name doesn't churn).
      voice:{ provider:'elevenlabs', voice:'kitt', speed:0.9, label:'NICE',
    ...
    { id:'lcars', name:'LCARS', builtin:true, accent:'#ff9966', preview:['#000000','#ff9966','#cc99ff'],
      ...
      // "Awaiting input.", "Computer." Default Starfleet ranks already match
