...
const Theme = (() => {
  ...
  const THEMES = [
    ...
    { id:'retro', name:'Retro', builtin:true, accent:'#00c8a0', preview:['#1a0f08','#00c8a0','#e86c3a'],
      data:{ colors:{ '--bg':'#1a0f08','--bg2':'#221408','--surface':'rgba(0,180,150,0.06)','--surface2':'rgba(230,100,50,0.07)','--border':'rgba(0,195,155,0.28)','--border-hi':'rgba(230,110,60,0.5)','--accent':'#00c8a0','--accent2':'#e86c3a','--text':'#f2e8d8','--text-muted':'rgba(242,232,216,0.55)','--glow':'0 0 18px rgba(0,195,155,0.2)','--panel-bg':'rgba(26,15,8,0.97)' }, fonts:{ '--font-h':"'Orbitron', sans-serif", '--font-b':"'Inter', sans-serif" }, radius:'4px' } },
    { id:'lcars', name:'LCARS', builtin:true, accent:'#ff9966', preview:['#000012','#ff9966','#bb88ff'],
      data:{ colors:{ '--bg':'#000012','--bg2':'#080020','--surface':'rgba(200,120,80,0.07)','--surface2':'rgba(180,140,255,0.07)','--border':'#cc7744','--border-hi':'#ff9966','--accent':'#ff9966','--accent2':'#bb88ff','--text':'#ffeecc','--text-muted':'rgba(255,220,180,0.55)','--glow':'0 0 14px rgba(255,120,80,0.22)','--panel-bg':'rgba(0,0,18,0.97)' }, fonts:{ '--font-h':"'Share Tech Mono', monospace", '--font-b':"'Inter', sans-serif" }, radius:'20px' } },
    { id:'pixel', name:'16-Bit Pixel', builtin:true, accent:'#ffff00', preview:['#0f0f23','#ffff00','#ff4444'],
      data:{ colors:{ '--bg':'#0f0f23','--bg2':'#1a1a3e','--surface':'#1a1a3e','--surface2':'#22224e','--border':'#5555aa','--border-hi':'#ffff00','--accent':'#ffff00','--accent2':'#ff4444','--text':'#ffffff','--text-muted':'#aaaacc','--glow':'none','--panel-bg':'#1a1a3e' }, fonts:{ '--font-h':"'Press Start 2P', monospace", '--font-b':"'Press Start 2P', monospace" }, radius:'0px' } },
