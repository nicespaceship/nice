...
const Theme = (() => {
  ...
  const THEMES = [
    ...
    { id:'robotech', name:'HAL-9000', builtin:true, accent:'#d4a373', preview:['#fafaf9','#d4a373','#ef4444'],
      data:{ colors:{ '--bg':'#fafaf9','--bg2':'#f5f0eb','--surface':'rgba(212,163,115,0.05)','--surface2':'rgba(212,163,115,0.08)','--border':'rgba(212,163,115,0.2)','--border-hi':'#d4a373','--accent':'#d4a373','--accent2':'#c4956b','--text':'#2c2420','--text-muted':'#9a8e84','--glow':'none','--panel-bg':'rgba(255,255,253,0.9)' }, fonts:{ '--font-h':"'Inter', sans-serif", '--font-b':"'Inter', sans-serif" }, radius:'9999px' } },
