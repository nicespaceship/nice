...
const Theme = (() => {
  ...
  const THEMES = [
    ...
    { id:'office', name:'The Office', builtin:true, accent:'#0a0a0a', preview:['#fafafa','#0a0a0a','#333'],
      data:{ colors:{ '--bg':'#fafafa','--bg2':'#f0f0f0','--bg-alt':'#ffffff','--surface':'transparent','--surface2':'#f0f0f0','--border':'#ccc','--border-hi':'#999','--accent':'#0a0a0a','--accent2':'#333','--text':'#0a0a0a','--text-muted':'#666','--text-dim':'#aaa','--glow':'none','--panel-bg':'#ffffff','--panel-border':'#ccc' }, fonts:{ '--font-h':"'Fira Code', monospace", '--font-b':"'Fira Code', monospace" }, radius:'0px' } },
    { id:'office-dark', name:'The Office', builtin:false, accent:'#00ff41', preview:['#0a0a0a','#00ff41','#333'],
      data:{ colors:{ '--bg':'#0a0a0a','--bg2':'#111','--bg-alt':'#0a0a0a','--surface':'transparent','--surface2':'#161616','--border':'#333','--border-hi':'#555','--accent':'#00ff41','--accent2':'#00cc33','--text':'#e0e0e0','--text-muted':'#888','--text-dim':'#444','--glow':'none','--panel-bg':'#111','--panel-border':'#333' }, fonts:{ '--font-h':"'Fira Code', monospace", '--font-b':"'Fira Code', monospace" }, radius:'0px' } },
  ];
