...
## Answered
- 2026-06-18 — *Q2 Untested models:* decided — **drop Codex** (redundant with OpenAI's GPT-5.4 Pro / o3 / GPT-5 mini; removed in [#848](https://github.com/nicespaceship/nice/pull/848)), **keep Grok + Llama**. Residual: Grok + Llama have still never run in prod, so a quick authenticated Pro smoke-test before launch stays on the `[BEN]` list — but they remain in the catalog.
